...
/**
 * Classes and menus for itop-tickets (version 3.1.0)
 *
  ...
  array (
    ...
    array (
      ...
      'rejected' => 'closed',
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSetIndirect("contacts_list", array("linked_class"=>'lnkContactToTicket', "ext_key_to_me"=>'ticket_id', "ext_key_to_remote"=>'contact_id', "count_min"=>0, "count_max"=>0, "duplicates"=>false, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSetIndirect("functionalcis_list", array("linked_class"=>'lnkFunctionalCIToTicket', "ext_key_to_me"=>'ticket_id', "ext_key_to_remote"=>'functionalci_id', "count_min"=>0, "count_max"=>0, "duplicates"=>false, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("workorders_list", array("linked_class"=>'WorkOrder', "ext_key_to_me"=>'ticket_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
;
	...
	protected function RegisterEventListeners()
	{
		...
		Combodo\iTop\Service\Events\EventService::RegisterListener("EVENT_DB_LINKS_CHANGED", [$this, 'UpdateImpactedItems'], $this->m_sObjectUniqId, [], null, 0, 'itop-tickets');
	}
