...
/**
 * Classes and menus for itop-structure (version 3.1.0)
 *
...
class Location extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("person_list", array("linked_class"=>'Person', "ext_key_to_me"=>'location_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "edit_mode"=>LINKSET_EDITMODE_ADDONLY, "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("physicaldevice_list", array("linked_class"=>'PhysicalDevice', "ext_key_to_me"=>'location_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "edit_mode"=>LINKSET_EDITMODE_ADDONLY, "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
abstract class Contact extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSetIndirect("cis_list", array("linked_class"=>'lnkContactToFunctionalCI', "ext_key_to_me"=>'contact_id', "ext_key_to_remote"=>'functionalci_id', "count_min"=>0, "count_max"=>0, "duplicates"=>false, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class Person extends Contact
{
  ...
  array (
    ...
    'is_blocking' => false,
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSetIndirect("team_list", array("linked_class"=>'lnkPersonToTeam', "ext_key_to_me"=>'person_id', "ext_key_to_remote"=>'team_id', "count_min"=>0, "count_max"=>0, "duplicates"=>false, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("user_list", array("linked_class"=>'User', "ext_key_to_me"=>'contactid', "count_min"=>0, "count_max"=>0, "display_style"=>'', "edit_mode"=>LINKSET_EDITMODE_ADDONLY, "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("tickets_list", array("linked_class"=>'Ticket', "ext_key_to_me"=>'caller_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "edit_mode"=>LINKSET_EDITMODE_ADDONLY, "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
;
	...
	protected function RegisterEventListeners()
	{
		...
		Combodo\iTop\Service\Events\EventService::RegisterListener("EVENT_DB_CHECK_TO_WRITE", [$this, 'CheckUsersOnUpdate'], $this->m_sObjectUniqId, [], null, 1, 'itop-structure');
	}
...
class Team extends Contact
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeLinkedSetIndirect("persons_list", array("linked_class"=>'lnkPersonToTeam', "ext_key_to_me"=>'team_id', "ext_key_to_remote"=>'person_id', "count_min"=>0, "count_max"=>0, "duplicates"=>false, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("tickets_list", array("linked_class"=>'Ticket', "ext_key_to_me"=>'team_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "edit_mode"=>LINKSET_EDITMODE_NONE, "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
abstract class Document extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSetIndirect("contracts_list", array("linked_class"=>'lnkContractToDocument', "ext_key_to_me"=>'document_id', "ext_key_to_remote"=>'contract_id', "count_min"=>0, "count_max"=>0, "duplicates"=>false, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSetIndirect("services_list", array("linked_class"=>'lnkDocumentToService', "ext_key_to_me"=>'document_id', "ext_key_to_remote"=>'service_id', "count_min"=>0, "count_max"=>0, "duplicates"=>false, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
