<?php
//
// File generated by ... on the 2024-04-02T09:30:38+0200
// Please do not edit manually
//

/**
 * Classes and menus for itop-standard-email-synchro (version 3.4.4)
 *
...
class MailInboxStandard extends MailInboxBase
{
	public static function Init()
	{
		$aParams = array(			'category' => 'grant_by_profile,application',
			...
			'style' =>  new ormStyle(null, null, null, null, null, 'itop-standard-email-synchro/images/mailbox.png'),);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeEnum("behavior", array("allowed_values"=>new ValueSetEnum("both,create_only,update_only" ), "display_style"=>'list', "sql"=>'behavior', "default_value"=>'both', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("target_class", array("allowed_values"=>new ValueSetEnum("Change,EmergencyChange,Incident,NormalChange,Problem,RoutineChange,UserRequest" ), "display_style"=>'list', "sql"=>'target_class', "default_value"=>'UserRequest', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeText("ticket_default_values", array("sql"=>'ticket_default_values', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("ticket_default_title", array("sql"=>'ticket_default_title', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("title_pattern", array("sql"=>'title_pattern', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeText("unknown_caller_rejection_reply", array("sql"=>'unknown_caller_rejection_reply', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeText("caller_default_values", array("sql"=>'caller_default_values', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeEmailAddress("notify_errors_to", array("sql"=>'notify_errors_to', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEmailAddress("notify_errors_from", array("sql"=>'notify_errors_from', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("trace", array("allowed_values"=>new ValueSetEnum("no,yes" ), "display_style"=>'list', "sql"=>'trace', "default_value"=>'no', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLongText("debug_trace", array("sql"=>'debug_trace', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("email_storage", array("allowed_values"=>new ValueSetEnum("delete,keep,move" ), "display_style"=>'list', "sql"=>'email_storage', "default_value"=>'keep', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("target_folder", array("sql"=>'target_folder', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("import_additional_contacts", array("allowed_values"=>new ValueSetEnum("always,never,only_on_creation,only_on_update" ), "display_style"=>'list', "sql"=>'import_additional_contacts', "default_value"=>'never', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeText("stimuli", array("sql"=>'stimuli', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class MenuCreation_itop_standard_email_synchro extends ModuleHandlerAPI
{
	public static function OnMenuCreation()
	{
		...
		$__comp_menus__['MailInboxes'] = new OQLMenuNode('MailInboxes', "SELECT MailInboxStandard", $__comp_menus__['ConfigurationTools']->GetIndex(), 30, true , 'MailInboxStandard', UR_ACTION_READ, UR_ALLOWED_YES, null, true);
	}
