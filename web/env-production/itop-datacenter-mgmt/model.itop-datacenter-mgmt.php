...
/**
 * Classes and menus for itop-datacenter-mgmt (version 3.1.0)
 *
...
class Rack extends PhysicalDevice
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("device_list", array("linked_class"=>'DatacenterDevice', "ext_key_to_me"=>'rack_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "edit_mode"=>LINKSET_EDITMODE_ADDONLY, "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("enclosure_list", array("linked_class"=>'Enclosure', "ext_key_to_me"=>'rack_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "edit_mode"=>LINKSET_EDITMODE_ADDONLY, "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class Enclosure extends PhysicalDevice
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeInteger("nb_u", array("sql"=>'nb_u', "is_null_allowed"=>true, "default_value"=>'', "allowed_values"=>null, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("device_list", array("linked_class"=>'DatacenterDevice', "ext_key_to_me"=>'enclosure_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "edit_mode"=>LINKSET_EDITMODE_ADDONLY, "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class PowerSource extends PowerConnection
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("pdus_list", array("linked_class"=>'PDU', "ext_key_to_me"=>'powerstart_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "edit_mode"=>LINKSET_EDITMODE_ADDONLY, "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
