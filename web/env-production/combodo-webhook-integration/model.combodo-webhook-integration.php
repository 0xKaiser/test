...
/**
 * Classes and menus for combodo-webhook-integration (version 1.3.1)
 *
...
class RemoteApplicationType extends Typology
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("remoteapplicationconnections_list", array("linked_class"=>'RemoteApplicationConnection', "ext_key_to_me"=>'remoteapplicationtype_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class RemoteApplicationConnection extends Typology
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("actions_list", array("linked_class"=>'ActionWebhook', "ext_key_to_me"=>'remoteapplicationconnection_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
