...
/**
 * Classes and menus for itop-oauth-client (version 3.1.0)
 *
...
abstract class OAuthClient extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeLinkedSet("mailbox_list", array("linked_class"=>'MailInboxOAuth', "ext_key_to_me"=>'oauth_client_id', "count_min"=>0, "count_max"=>0, "display_style"=>'', "allowed_values"=>null, "with_php_constraint"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
